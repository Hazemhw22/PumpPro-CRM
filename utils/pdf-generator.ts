...
export { generateBillPDF, generateGeneralBillPDF, generateTaxInvoicePDF, generateReceiptOnlyPDF, generateTaxInvoiceReceiptPDF, type BillData, type PDFOptions } from '@/utils/pdf-generators';

// Re-export with alias for backward compatibility
export { generateReceiptOnlyPDF as generateReceiptPDF } from '@/utils/pdf-generators';
...
export const downloadPublicPDF = (url: string, filename = '') => {
    try {
