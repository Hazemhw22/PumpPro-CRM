...
const CustomerFilters: React.FC<FilterProps> = ({ onFilterChange, onClearFilters, viewMode = 'list', onViewModeChange }) => {
        ...
        <div className="">
            <div className=" flex flex-col gap-5 md:flex-row md:items-center">
                ...
                <div className="ltr:ml-auto rtl:mr-auto relative flex items-center gap-2">
                    ...
                    <input type="text" className="form-input w-60 pl-10" placeholder={t('search')} value={filters.search} onChange={(e) => handleInputChange('search', e.target.value)} />
