...
import CustomerFilters, { CustomerFilters as CustomerFiltersType } from '@/components/customer-filters/customer-filters';
    ...
    useEffect(() => {
        setInitialRecords(() => {
            return items.filter((item) => {
                ...
                const inType = customerType === 'all' || item.type === customerType;
                                ...
                                <tbody>
                                    ...
                                    {records.map((row) => (
                                        <tr key={row.id}>
                                            ...
                                            <td>
                                                <span className={`badge ${row.type === 'private' ? 'badge-outline-primary' : 'badge-outline-success'}`}>
                                                    {row.type === 'private' ? 'Private' : 'Business'}
                                                </span>
                                            </td>
                                            <td>{row.address || '-'}</td>
                                            <td>{row.phone}</td>
