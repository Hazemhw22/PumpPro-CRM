                    ...
                    <div className="relative hidden w-full items-center justify-center bg-[linear-gradient(225deg,#03113b_0%,rgba(67,97,238,1)_100%)] p-5 lg:inline-flex lg:max-w-[835px] xl:-ms-28 ltr:xl:skew-x-[14deg] rtl:xl:skew-x-[-14deg]">
                        ...
                        <div className="ltr:xl:-skew-x-[14deg] rtl:xl:skew-x-[14deg]">
                            ...
                            <div className="mt-24 hidden w-full max-w-[430px] lg:block">
                                <img src="/assets/images/auth/Cargo-Truck-Transparent-Free-PNG.png" alt="Cargo Truck" className="absolute -right-[555px] w-[850px] max-w-none -bottom-[340px]" />
                            </div>
                        </div>
                    </div>
                    <div className="relative flex w-full flex-col items-center justify-center gap-6 px-4 pb-16 pt-6 sm:px-6 lg:max-w-[667px]">
                        <div className="flex w-full max-w-[440px] items-center gap-2 lg:absolute lg:end-6 lg:top-6 lg:max-w-full">
                            <Link href="/" className="block w-8 lg:hidden">
                                <img src="/assets/images/auth/Cargo-Truck-Transparent-Free-PNG.png" alt="Logo" className="mx-auto w-28 max-w-none" />
                            </Link>
